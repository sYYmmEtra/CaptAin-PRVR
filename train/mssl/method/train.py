...
def start_training(opt):
    ...
    # caption
    caption_files = {'train':f"../dataset/{dataset_files}/TextData/{opt.dataset_name}train.caption.txt",
                     'val':f"../dataset/{dataset_files}/TextData/{opt.dataset_name}val.caption.txt",}
    # Load visual features
